...
def start_blackboard():
    ...
    font_size_img = cv2.resize(cv2.imread('images/font_size.png', 1), (50, 50))
    lunar_img = cv2.resize(cv2.imread('images/lunar.jpg', 1), (500, 500))
    test_img = cv2.resize(cv2.imread('images/test.png', 1), (500, 500))
    ...
    while (1):
        ...
        if k == 27:
            ...
            #tmpcanvas[100:600,400:900]=lunar_img
